...
export default guide({
  ...
  sections: [
    {
      heading: "The statutory minimum: 5.6 weeks of paid leave",
      body:
  ...
  faq: [
    {
      question: "How much statutory holiday am I entitled to in the UK?",
      answer:
    ...
    {
      question: "What holiday pay must include overtime and commission?",
      answer:
    ...
    {
      question: "How do I calculate holiday entitlement for a mid-year starter?",
      answer:
