...
export default guide({
  ...
  title: "Employer NI Rates 2026/27 UK",
  metaDescription:
  ...
  sections: [
    ...
    {
      heading: "How to calculate employer NI step by step",
      body:
    ...
    {
      heading: "Worked example: employer NI on a £30,000 salary",
      body:
    ...
    {
      heading: "Younger employees, apprentices and other category letters",
      body:
    ...
    {
      heading: "Class 1A and Class 1B: employer NI on benefits and PSAs",
      body:
  ...
  faq: [
    ...
    {
      question: "What is the employer NI threshold for 2026/27?",
      answer:
    ...
    {
      question: "How much employer NI do I pay on a £30,000 salary?",
      answer:
    ...
    {
      question: "What are the UK national insurance rates 2026/27 for employees?",
      answer:
    ...
    {
      question: "What are the UK national insurance rates for 2026/27 by class?",
      answer:
    ...
    {
      question: "What are the income tax and national insurance thresholds for 2026/27?",
      answer:
    ...
    {
      question: "What is the income tax and national insurance rate for 2026/27?",
      answer:
    ...
    {
      question: "What is the national insurance reduction 2026 for employers?",
      answer:
    ...
    {
      question: "Can I reduce my employer NI bill?",
      answer:
    ...
    {
      question: "Do I pay employer NI on bonuses and overtime?",
      answer:
    ...
    {
      question: "Is the employer NI rate the same across the UK?",
      answer:
    ...
    {
      question: "How does this compare to the 2025/26 employer NI rates?",
      answer:
    ...
    {
      question: "What are the HMRC national insurance rates and thresholds 2025 to 2026?",
      answer:
