...
export default guide({
  ...
  title: "SSP Changes April 2026 Explained",
  metaDescription:
    "SSP changes from April 2026: day-one payment, no lower earnings limit, 80% earnings cap, £123.25 rate and Fair Work Agency enforcement.",
  ...
  faq: [
    ...
    {
      question: "Are SSP waiting days abolished from April 2026?",
      answer:
    ...
    {
      question: "Do all employees now qualify for SSP?",
      answer:
    ...
    {
      question: "What is the 80% earnings cap on SSP?",
      answer:
    ...
    {
      question: "How much extra does day-one SSP cost employers?",
      answer:
