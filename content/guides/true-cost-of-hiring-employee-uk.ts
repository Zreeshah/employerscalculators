...
export default guide({
  ...
  sections: [
    {
      heading: "What does first-year hiring cost include?",
      body: "A complete hiring budget has two layers. The **recurring employment baseline** covers salary and ongoing employer costs. The **first-year hiring layer** covers recruitment, selection, pre-employment checks, equipment, initial access, induction, training, management time and the productivity gap while the employee learns the role.\n\nUse this formula: recurring employment baseline + recruitment + setup + onboarding and training + ramp-up + temporary cover + one-off compliance. GOV.UK provides the official starting points for right-to-work checks, workplace pensions, PAYE and employer's liability insurance. ACAS recruitment and induction guidance helps turn those legal steps into a fair, consistent process.",
    },
    {
      heading: "Recruitment and selection before day one",
      body: "Count more than the advert or agency invoice. Include job-description preparation, advertising, recruiter fees, applicant tracking, interview-platform charges, candidate travel where paid, work-sample administration and the loaded cost of staff time spent shortlisting and interviewing.\n\nFor example, a manager spending 20 hours and two colleagues spending five hours each creates 30 hours of internal selection cost. Value those hours at their employment cost, not just take-home pay. A replacement hire may also need temporary cover or overtime during the vacancy. Keep agency fees and internal time separate so a no-fee recruitment channel is not mistaken for a no-cost hire.",
    },
    {
      heading: "Pre-employment and setup costs",
  ...
  faq: [
    ...
    {
      question: "How do I calculate the first-year cost of a new hire?",
      answer:
    ...
    {
      question: "Why does a new employee cost more in year one?",
      answer:
    ...
    {
      question: "Should interview time be included in hiring cost?",
      answer:
    ...
    {
      question: "How should ramp-up cost be estimated?",
      answer:
    ...
    {
      question: "Does a first employee cost more than a later hire?",
      answer:
    ...
    {
      question: "Is this the same as the annual cost of employing someone?",
      answer:
