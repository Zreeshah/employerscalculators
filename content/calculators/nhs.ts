...
const createEnglandBandContent = (band: string, config: TargetBandConfig): CalculatorContent => {
  ...
  const englandSeoTitleByBand: Record<string, string> = {
    "4": "NHS Band 4 Pay Calculator England",
    "5": "NHS Band 5 Pay Calculator England",
    "7": "NHS Band 7 Pay Calculator England",
    "8a": "NHS Band 8a Pay Calculator England",
    "8b": "NHS Band 8b Pay Calculator England",
    "9": "NHS Band 9 Pay Calculator England",
  };
  ...
  return calculator({
    ...
    title: englandSeoTitleByBand[band] ?? `NHS Band ${band} Pay Calculator England`,
    metaDescription: `NHS Band ${band} pay calculator England 2026/27: ${gbp(entry)}–${gbp(top)} salary, net pay after tax, pension and NI with FTE examples`,
...
const createScotlandBand6Content = (): CalculatorContent => {
  ...
  return calculator({
    ...
    title: "NHS Scotland Band 6 Pay Calculator",
...
const createGenericBandContent = (band: string, nation: Nation): CalculatorContent => {
  ...
  return calculator({
    ...
    title: `${bandTitle} Pay Calculator ${label}`,
...
const createScotlandBandContent = (band: string, config: ScotlandBandConfig): CalculatorContent => {
  ...
  return calculator({
    ...
    title: `NHS Scotland Band ${band} Pay Calculator`,
...
const createWalesBandContent = (band: string, config: WalesBandConfig): CalculatorContent => {
  ...
  return calculator({
    ...
    title: `NHS Wales Band ${band} Pay Calculator`,
