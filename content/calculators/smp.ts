...
export default calculator({
  ...
  slug: "smp-calculator",
  kind: "smp",
  title: "SMP Calculator UK 2026/27",
  metaDescription:
    "SMP calculator for 2026/27: 90% of average weekly earnings for 6 weeks, then the statutory rate or 90% if lower for 33 weeks.",
