...
export default calculator({
  ...
  metaDescription:
    "Free IR35 calculator for 2026/27. Work out your inside-IR35 take-home pay and compare with the outside-IR35 route. 15% employer NI, then income tax and employee NI on the deemed pay.",
  h1: "IR35 Calculator",
  intro:
