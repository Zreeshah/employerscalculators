...
const pillarPage = (): CalculatorContent => {
  ...
  return calculator({
    ...
    kind: "teachers-pay",
    title: "Teachers Pay Calculator UK 2026/27",
...
const mainPayPage = (): CalculatorContent => {
  ...
  return calculator({
    ...
    kind: "teachers-pay",
    title: "Teachers Main Pay Scale 2026/27",
    metaDescription: "Teachers Main Pay Range M1 to M6 for 2026/27. Compare salaries across Rest of England, Inner London, Outer London and Fringe with pension tiers.",
...
const upperPayPage = (): CalculatorContent => {
  ...
  return calculator({
    ...
    kind: "teachers-pay",
    title: "Teachers Upper Pay Scale 2026/27",
...
const leadershipPage = (): CalculatorContent => {
  ...
  return calculator({
    ...
    kind: "teachers-pay",
    title: "Teachers Leadership Pay 2026/27",
    metaDescription: "Teachers leadership pay 2026/27: head teacher, deputy and assistant head salary ranges across England. School group bands, ISR guidance and pension tiers.",
...
const scotlandPage = (): CalculatorContent => {
  ...
  return calculator({
    ...
    kind: "teachers-pay",
    title: "Scottish Teachers Pay Scale 2026/27",
...
const walesPage = (): CalculatorContent => {
  ...
  return calculator({
    ...
    kind: "teachers-pay",
    title: "Teachers Pay Scale Wales 2026/27",
    metaDescription: "Teachers pay scale Wales 2026/27: Main M1-M6, Upper UPS1-UPS3 and Unqualified rates under STPCD with Welsh tax and pension tiers.",
...
const londonPage = (): CalculatorContent => {
  ...
  return calculator({
    ...
    kind: "teachers-pay",
    title: "Teachers Pay Scale London 2026/27",
    metaDescription: "London teachers pay scale 2026/27: Inner London, Outer London and Fringe rates for Main and Upper ranges. Which boroughs qualify.",
